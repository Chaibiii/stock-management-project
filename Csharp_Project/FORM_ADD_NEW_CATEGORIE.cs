    ...
    public partial class FORM_ADD_NEW_CATEGORIE : Form
    {
        ...
        private void BTN_ADD_CATEGORY_Click(object sender, EventArgs e)
        {
            if(TB_CATEGORY_NAME.Text != string.Empty)
            {
                ...
                MessageBox.Show("Nouvelle catégorie insérée avec succès", "Insérer une catégorie", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }else
            {
                MessageBox.Show("entrer le nom de Catégories");
            }
