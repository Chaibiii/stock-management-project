...
namespace Csharp_Project
{
    public partial class FORM_NEW_PRODUCT : Form
    {
        ...
        private void BTN_ADD_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("La quantité et le prix ne peuvent pas être vides | Mais peut être égal à0", "les Données sont vides", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else if (PB_BROWSE_IMAGE.Image == null)
            {
                MessageBox.Show("Aucune image sélectionnée", "Pas d'image", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            ...
            else
            {
                ...
                MessageBox.Show("Nouveau produit inséré avec succès", "Nouveau produit", MessageBoxButtons.OK, MessageBoxIcon.Information);
