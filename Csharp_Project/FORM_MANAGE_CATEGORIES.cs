    ...
    public partial class FORM_MANAGE_CATEGORIES : Form
    {
        ...
        public FORM_MANAGE_CATEGORIES()
        {
            ...
            try
            {
                ...
                LSTB_PRODUCTS_IN_CATEGORY.DisplayMember = "Nom_PRO";
                LSTB_PRODUCTS_IN_CATEGORY.ValueMember = "ID_Pro";
            }catch(Exception ex)
            {
        ...
        private void BTN_INSERT_CTG_Click(object sender, EventArgs e)
        {
            ...
            if(TB_CATG_NAME.Text != string.Empty)
            {
                ...
                MessageBox.Show("votre Catégories été bien ajouter", "Insérer une catégorie", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void BTN_DELETE_CTG_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show("Voulez-vous vraiment supprimer cette catégorie", "supprimmer catégorie", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        DGV_CATEGORIES.DataSource = table;
                        MessageBox.Show("catégorie bien supprimer", "Supprimer la catégorie");
                        TB_CATG_ID.Text = "";
                        TB_CATG_NAME.Text = "";
                    }
            ...
            {
                MessageBox.Show("ID vide", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void BTN_UPDATE_CTG_Click(object sender, EventArgs e)
        {
            if (TB_CATG_ID.Text != string.Empty || TB_CATG_NAME.Text != string.Empty)
           {
               try
               {
                   ...
                   MessageBox.Show("Catégorie mise à jour avec succès", "mise à jour Catégorie ", MessageBoxButtons.OK, MessageBoxIcon.Information);
                   DGV_CATEGORIES.DataSource = category.getCategories();
               }
           ...
           {
               MessageBox.Show("les Données vides", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
           }
