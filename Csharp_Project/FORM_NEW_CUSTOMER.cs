...
namespace Csharp_Project
{
    public partial class FORM_NEW_CUSTOMER : Form
    {
        ...
        private void BTN_ADD_CUSTOMER_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Un ou plusieurs champs sont vides", "les Champs sont  vides", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                customer.insertCustomer(TB_FNAME.Text, TB_LNAME.Text, TB_TEL.Text, TB_EMAIL.Text);

                MessageBox.Show("Client ajouté", "Ajouter un client", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
