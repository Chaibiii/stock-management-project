...
namespace Csharp_Project
{
    public partial class FORM_NEW_USER : Form
    {
        ...
        private void BTN_ADD_CUSTOMER_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Un ou plusieurs champs sont vides", "Champs vides", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                user.insertUser(TB_USERNAME.Text, TB_FULLNAME.Text, TB_PASSWORD.Text, TB_TEL.Text, TB_EMAIL.Text);
                MessageBox.Show("Nouveau utilisateur inséré avec succès", "Nouveau utilisateur", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
